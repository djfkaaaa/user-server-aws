...
import { getLoginMessage, getUserByUsername } from "./components/users/service/user-slice";
import { exitsByUsername, loginUser } from "./components/users/service/user-service";
...
const LoginPage = () => {
  ...
  <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
    ...
    <div className="w-full p-8 lg:w-1/2">
      ...
      {isWrongId && (<pre>
        <h6 className="text-red-500">잘못된 아이디 입니다.</h6>
      </pre>)}
      {!getUsers && (<pre>
        <h6 className="text-red-500">없는 아이디 입니다.</h6>
      </pre>)}
      ...
      {isWrongPw && (<pre>
        <h6 className="text-red-500">잘못된 비밀번호 입니다.</h6>
      </pre>)}
      <div className="mt-8">
        <button 
